  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      <style>{`
        ...
        @keyframes starPulse {
          0%, 100% { opacity: 0.2; transform: scale(0.5) translate3d(0,0,0); }
          50% { opacity: 1; transform: scale(1.5) translate3d(0,0,0); }
        }
        ...
        @keyframes shootingStar {
          0% { transform: translate3d(-100px, 0px, 0) scaleX(0); opacity: 0; }
          10%, 90% { opacity: 1; }
          100% { transform: translate3d(1000px, 200px, 0) scaleX(50); opacity: 0; }
        }
        @keyframes particleFieldFloat {
          0%, 100% { transform: translate3d(0px, 0px, 0); opacity: 0.3; }
          50% { transform: translate3d(var(--target-x), -100px, 0); opacity: 0.8; }
        }
      `}</style>
